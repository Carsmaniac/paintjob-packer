...
vehicle_type = manual["Params"]["vehicle_type"]
...
paintjob.Files.copy_image_files(truck_list="manual", internal_name=internal_name, new_truck_format=new_truck_format, make=make, model=model, accessory_name_list=accessory_name_list, trailer=trailer) # TODO: different file name for man skins, for easy save-compile-testing
